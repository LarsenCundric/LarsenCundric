...
Founding Engineer at [Browser Use](https://browser-use.com) building infrastructure for AI browser agents at scale.
...
| Tool | What it does |
|---|---|
| [`git who`](https://github.com/LarsenCundric/git-who-cli) | Find who knows a file best — blame + log = ownership insights |
